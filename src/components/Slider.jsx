  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="flex gap-x-20 lg:items-start items-center lg:flex-row flex-col">
        ...
        <div className="relative sm:w-[400px]  w-[320px] mt-22 lg:mt-5"> 
          {descriptions.map((description, i) => (
            <p key={i} className={`text-center sm:text-xl text-gray-600 absolute transition-all duration-300 ${i === index ? "activeDescription delay-200" : "inactiveDescription" }`}>
              {description}
      ...
      <div className="absolute bottom-0 lg:-bottom-20 left-1/2 -translate-1/2 flex gap-x-5">
        <button  className="bg-gray-100 p-1.5 cursor-pointer rounded-full text-gray-600 hover:bg-gray-200 transition-colors " onClick={() => 
